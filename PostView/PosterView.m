...
- (void)_initheaderView {
    ...
    _headerView.frame = CGRectMake(0, -KHeaderViewHeight, 375, KHeaderViewHeight + 26);
    //开启触摸响应
    ...
    arrowButton.frame = CGRectMake((375-15)/2, KHeaderViewHeight + 26-20, 15, 15);
    //添加点击事件
...
- (void)_initIndexTableView {
    ...
    _indexView = [[IndexCollectionView alloc] initWithFrame:CGRectMake(0, 0, 375, KHeaderViewHeight)];
    //设置一页宽度
...
- (void)_initPosterView {
    ...
    //创建海报视图
    _posterCollectionView = [[PosterCollectionView alloc] initWithFrame:CGRectMake(0, 26, 375, 667-64-26-49-KFooterHeight)];
...
- (void)_initFooterView {
    ...
    _footerlabel = [[UILabel alloc] initWithFrame:CGRectMake(0, self.height-KFooterHeight, 375, KFooterHeight)];
    //设置背景颜色
